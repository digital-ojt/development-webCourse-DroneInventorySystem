...
public class GlobalExceptionHandler {
  ...
  private String handleException(
      Exception ex, RedirectAttributes redirectAttributes, HttpServletRequest request) {
  ...
  public String handleDatabaseException(
      InvalidInputException ex, RedirectAttributes redirectAttributes) {
    String errorMessage = ex.getMessage();
    redirectAttributes.addFlashAttribute(LogMessage.FLASH_ATTRIBUTE_ERROR, errorMessage);
  ...
  public String handleDatabaseException(
      DataAccessException ex, RedirectAttributes redirectAttributes) {
    String errorMessage = ex.getMessage();
    redirectAttributes.addFlashAttribute(LogMessage.FLASH_ATTRIBUTE_ERROR, errorMessage);
    return "redirect:" + UrlConsts.ERROR;
  }
